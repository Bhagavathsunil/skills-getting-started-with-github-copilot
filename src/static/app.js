    ...
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantsList = details.participants
          .map((email, index) => `<li><span class="participant-email">${email}</span><button class="delete-participant-btn" data-activity="${name}" data-email="${email}" data-index="${index}" title="Remove participant">✕</button></li>`)
          .join("");
